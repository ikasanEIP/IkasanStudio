...
<#if module.configuredProperties.ApplicationPackageName.value??>
module.package=${module.configuredProperties.ApplicationPackageName.value}
</#if>
...
<#list module.getFlows()![] as flow>
    <#list flow.getFlowComponentList()![] as ikasanComponent>
        <#if (ikasanComponent.getStandardConfiguredProperties())??>
            <#list ikasanComponent.getStandardConfiguredProperties() as propName, propValue>
