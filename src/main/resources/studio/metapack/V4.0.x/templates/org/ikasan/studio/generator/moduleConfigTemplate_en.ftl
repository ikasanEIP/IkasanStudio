...
<#if module.getAllUniqueSortedImportConfigurationClasses()?has_content>
@org.springframework.context.annotation.Import({
<#list module.getAllUniqueSortedImportConfigurationClasses() as importClass>
${importClass}.class<#if !importClass?is_last>,</#if>
</#list>
})
</#if>
