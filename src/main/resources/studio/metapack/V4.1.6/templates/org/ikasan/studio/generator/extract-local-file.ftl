            if (source.size() != 1 || source.get(0) == null) throw new TransformationException("This recipe requires exactly one local file; split the batch or use a custom converter");
            java.nio.file.Path path = source.get(0).toPath();
