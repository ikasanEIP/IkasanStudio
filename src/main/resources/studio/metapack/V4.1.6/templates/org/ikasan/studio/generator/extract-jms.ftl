            Object body;
            if (source instanceof jakarta.jms.TextMessage) {
                body = ((jakarta.jms.TextMessage) source).getText();
            } else if (source instanceof jakarta.jms.BytesMessage) {
                jakarta.jms.BytesMessage message = (jakarta.jms.BytesMessage) source;
                message.reset();
                try {
            ...
            } else if (source instanceof jakarta.jms.MapMessage) {
                jakarta.jms.MapMessage message = (jakarta.jms.MapMessage) source;
