...
/**
 * Shared HTTP client for POSTing to a running module's /rest/studio/inject/{flowName} endpoint (generated by
...
public final class StudioInjectClient {
    ...
    public static HttpResponse<String> postPayload(Module module, String flowName, String payload, String payloadClassName) throws Exception {
        ...
        // /rest/studio/inject, not /studio/inject: Ikasan's default security config CSRF-exempts /rest/** but
        // not an unmatched path (see StudioInjectControllerTemplate's own comment) - a POST to a path outside
