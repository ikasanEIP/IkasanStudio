...
public class IkasanFlowUIComponentFactory {
    ...
    private static String LOCAL_FILE_CONSUMER_HELP_TEXT = "This consumer is a variation of Scheduled Consumer which is a \"time event\" based consumer configured to be either an absolute or relative time schedule, backed by Local File MessageProvider. Payload in: Na / Payload out - A list for java.util.File for the discovered files.";
    ...
    private static String LOGGING_PRODUCER_HELP_TEXT = "Ending component of the flow, or a route in the flow. This type of producer logs all data passed to it. Payload in: Any java Object. Process: call toString on the supplied payload, output the results to a log. Payload out: N/A";
