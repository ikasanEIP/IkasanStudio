...
public class IkasanFlowUIComponentFactory {
    ...
    private IkasanFlowUIComponentFactory() {
        UNKNOWN = createIkasanFlowUIComponent("Bespoke Generator", BESPOKE_HELP_TEXT, DEFAULT_README, IkasanComponentType.UNKNOWN, "unknown");
        //@todo add in link to online ikasan help
        ikasanFlowUIComponents.add(createIkasanFlowUIComponent("Flow",FLOW_HELP_TEXT, DEFAULT_README, IkasanComponentType.FLOW, "flow"));

        ikasanFlowUIComponents.add(createIkasanFlowUIComponent("Aggregator","Aggregator is an ipsum", DEFAULT_README, IkasanComponentType.UNKNOWN, "aggregator"));
        ...
        ikasanFlowUIComponents.add(createIkasanFlowUIComponent("Delay Generation Broker", BROKER_HELP_TEXT, DEFAULT_README, IkasanComponentType.DELAY_GENERATION_BROKER, "broker"));
        ikasanFlowUIComponents.add(createIkasanFlowUIComponent("DB Broker", BROKER_HELP_TEXT, DEFAULT_README, IkasanComponentType.DB_BROKER, "broker"));
        ikasanFlowUIComponents.add(createIkasanFlowUIComponent("Schedule Rule Check Broker", BROKER_HELP_TEXT, DEFAULT_README, IkasanComponentType.SCHEDULE_RULE_CHECK_BROKER, "broker"));

        ikasanFlowUIComponents.add(createIkasanFlowUIComponent("Channel", CHANNEL_HELP_TEXT, DEFAULT_README, IkasanComponentType.CHANNEL, "channel"));
        ikasanFlowUIComponents.add(createIkasanFlowUIComponent("Channel Adapter", CHANNEL_HELP_TEXT, DEFAULT_README, IkasanComponentType.CHANNEL, "channel-adapter"));
...
//        ikasanFlowUIComponents.add(createIkasanFlowUIComponent("Event Driven Consumer", CONSUMER_HELP_TEXT, DEFAULT_README, IkasanComponentType.EVENT_DRIVEN_CONSUMER, "event-driven-consumer"));
        ikasanFlowUIComponents.add(createIkasanFlowUIComponent("Event Generating Consumer", CONSUMER_HELP_TEXT, DEFAULT_README, IkasanComponentType.EVENT_GENERATING_CONSUMER, "event-driven-consumer"));
...
//        ikasanFlowUIComponents.add(createIkasanFlowUIComponent("Generic Message Consumer", GENERIC_MESSAGE_CONSUMER_HELP_TEXT, "endpoint/jms-client/consumer.md", IkasanComponentType.JMS_CONSUMER, "message-consumer"));
        ...
        ikasanFlowUIComponents.add(createIkasanFlowUIComponent("Object Message to XML String Converter", OBJECT_MESSAGE_XML_STRING_CONVERTER_HELP_TEXT, "converter/ObjectToXmlStringConverter.md", IkasanComponentType.OBJECT_MESSAGE_TO_XML_STRING_CONVERTER, "converter"));
        ...
        ikasanFlowUIComponents.add(createIkasanFlowUIComponent("XML String to Object Converter", XML_STRING_OBJECT_CONVERTER_HELP_TEXT, "component/converter/XmlStringToObjectConverter.md", IkasanComponentType.XML_STRING_TO_OBJECT_CONVERTER, "converter"));
        ...
        ikasanFlowUIComponents.add(createIkasanFlowUIComponent("Payload to Map Converter", PAYLOAD_TO_MAP_CONVERTER_HELP_TEXT, DEFAULT_README, IkasanComponentType.PAYLOAD_TO_MAP_CONVERTER, "message-translator"));

        ikasanFlowUIComponents.add(createIkasanFlowUIComponent("Single Recipient Router", ROUTER_HELP_TEXT, DEFAULT_README, IkasanComponentType.SINGLE_RECIPIENT_ROUTER, "message-router"));
        ikasanFlowUIComponents.add(createIkasanFlowUIComponent("Multi Recipient Router", ROUTER_HELP_TEXT, DEFAULT_README, IkasanComponentType.MULTI_RECIPIENT_ROUTER, "message-router"));

        ikasanFlowUIComponents.add(createIkasanFlowUIComponent("Dev Null Producer", DEV_NULL_PRODUCER_HELP_TEXT, DEFAULT_README, IkasanComponentType.DEV_NULL_PRODUCER, "dev-null-producer"));
        ...
        ikasanFlowUIComponents.add(createIkasanFlowUIComponent("Filter", FILTER_HELP_TEXT, DEFAULT_README, IkasanComponentType.MESSAGE_FILTER, "message-filter"));
        ikasanFlowUIComponents.add(createIkasanFlowUIComponent("Message Translator", TRANSLATOR_HELP_TEXT, DEFAULT_README, IkasanComponentType.TRANSLATOR, "message-translator"));

        ikasanFlowUIComponents.add(createIkasanFlowUIComponent("Ftp Location", ENDPOINT_HELP_TEXT, DEFAULT_README, IkasanComponentType.FTP_LOCATION, "sftp-location"));
        ikasanFlowUIComponents.add(createIkasanFlowUIComponent("Sftp Location", ENDPOINT_HELP_TEXT, DEFAULT_README, IkasanComponentType.SFTP_LOCATION, "sftp-location"));

        ikasanFlowUIComponents.add(createIkasanFlowUIComponent("Bespoke Generator", BESPOKE_HELP_TEXT, DEFAULT_README, IkasanComponentType.UNKNOWN, "unknown"));
