...
//    static final ImageIcon shortIcon = new ImageIcon("short.gif");
    ...
    {
//        IkasanFlowUIComponent ikasanFlowUIComponent = (IkasanFlowUIComponent)value;
//        setText(ikasanFlowUIComponent.getText());
//        setIcon(ikasanFlowUIComponent.getSmallIcon());
