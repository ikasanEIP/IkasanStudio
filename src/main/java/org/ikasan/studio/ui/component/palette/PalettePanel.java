...
public class PalettePanel extends JPanel {
    ...
    public PalettePanel(String projectKey) {
        ...
        paletteExportTransferHandler = new PaletteExportTransferHandler();
...
//        paletteScrollPane.add(paletteList);
        ...
        paletteScrollPane.getViewport().setView(paletteList);
    }
...
////        paletteScrollPane = new JScrollPane();
//        paletteScrollPane.add(paletteList);
//        paletteScrollPane.setVerticalScrollBarPolicy(VERTICAL_SCROLLBAR_AS_NEEDED);
//        paletteScrollPane.setHorizontalScrollBarPolicy(HORIZONTAL_SCROLLBAR_AS_NEEDED);
//        paletteScrollPane.setBorder(BorderFactory.createEmptyBorder(0,0,0,0));
//        paletteScrollPane.getViewport().setView(paletteList);
