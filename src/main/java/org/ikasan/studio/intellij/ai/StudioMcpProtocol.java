    ...
    static List<Map<String, Object>> definitions() {
        ...
        Map<String, Object> operation = Map.of("type", "object", "description",
                ...
                "properties", Map.ofEntries(
                        Map.entry("type", Map.of("type", "string", "enum", List.of("addFlow", "deleteFlow", "setFlowProperty", "addComponent", "setProperty", "renameComponent", "deleteComponent", "replaceComponent", "connect", "configureRoutes", "setExceptionResolution"))),
