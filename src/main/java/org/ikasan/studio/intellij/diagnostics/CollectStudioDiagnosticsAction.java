...
public final class CollectStudioDiagnosticsAction extends DumbAwareAction implements PluginAware {
    private String pluginVersion = "unavailable";

    @Override public void setPluginDescriptor(PluginDescriptor descriptor) {
        pluginVersion = descriptor.getVersion() == null ? "unavailable" : descriptor.getVersion();
    }
    ...
    @Override public void actionPerformed(AnActionEvent event) {
        ...
        Map<String, String> metadata = Map.of("pluginVersion", pluginVersion,
