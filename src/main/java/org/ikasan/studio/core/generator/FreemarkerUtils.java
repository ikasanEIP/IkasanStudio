...
public class FreemarkerUtils {
    ...
    public static String generateFromTemplate(String version, String templateName, Map<String, Object> configurations) throws StudioGeneratorException {
        String output;
        try (StringWriter writer = new StringWriter()) {
            addSupportForJavaUtilsClasses(configurations);
            Template template = BuildContext.getFreemarkerConfig(version).getTemplate(templateName);
