...
class PojoDeserialisationTest {
    ...
    public void testWhenJsonDoesNotContainPayloadAttribute_ThenExceptionIsThrown() {
        Exception exception = assertThrows(StudioException.class, () -> PojoDeserialisation.deserializePojo("empty.json",
                new TypeReference<GenericPojo<MyGenericClass>>() {
                }));
    ...
    public void testWhenIncorrectDataFileNameProvided_ThenExceptionIsThrown() {
        Exception exception = assertThrows(StudioException.class, () -> PojoDeserialisation.deserializePojo("xx.json",
                new TypeReference<GenericPojo<MyGenericClass>>() {
                }));
