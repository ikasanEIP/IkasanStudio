...
public class FlowTemplateTest extends AbstractGeneratorTestFixtures {
  ...
  /**
     ...
     */
    @Test
    public void testCreateFlowWith_customTranslator() throws IOException, StudioBuildException, StudioGeneratorException {
        FlowElement flowElement = TestFixtures.getCustomTranslator();
        String templateString = generateFlowTemplateString(flowElement);
        assertEquals(GeneratorTestUtils.getExptectedFreemarkerOutputFromTestFile(flowElement, TEST_FLOW_NAME + "FullyPopulatedCustomTranslatorComponent.java"), templateString);
    }
     ...
     */
    @Test
    public void testCreateFlowWith_transitionDebugConverter() throws IOException, StudioBuildException, StudioGeneratorException {
        FlowElement flowElement = TestFixtures.getDebugTransition();
        String templateString = generateFlowTemplateString(flowElement);
        assertEquals(GeneratorTestUtils.getExptectedFreemarkerOutputFromTestFile(flowElement, TEST_FLOW_NAME + "FullyPopulatedDebugTransitionComponent.java"), templateString);
    }
     ...
     */
    @Test
    public void testCreateFlowWith_defaultMessageFilter() throws IOException, StudioBuildException, StudioGeneratorException {
        FlowElement flowElement = TestFixtures.getDefaultMessageFilter();
        String templateString = generateFlowTemplateString(flowElement);
        assertEquals(GeneratorTestUtils.getExptectedFreemarkerOutputFromTestFile(flowElement, TEST_FLOW_NAME + "FullyPopulatedDefaultMessageFilterComponent.java"), templateString);
    }
