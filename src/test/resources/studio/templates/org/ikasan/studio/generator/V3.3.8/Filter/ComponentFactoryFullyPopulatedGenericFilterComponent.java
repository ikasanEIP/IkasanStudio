...
@javax.annotation.Resource
co.uk.test.myflow1.myFilter myGenericFilter;
@javax.annotation.Resource
co.uk.test.myflow1.MyConfigurationClass myConfigurationClass;

public org.ikasan.spec.component.filter.Filter getMyGenericFilter() {
myGenericFilter.setConfiguration(myConfigurationClass);
myGenericFilter.setConfiguredResourceId("MyResourceID");
return myGenericFilter;
}}