...
*/
@org.springframework.stereotype.Component("org.ikasan.MyFlow1")
...
.addExceptionToAction(jakarta.jms.JMSException.class, org.ikasan.builder.OnException.retry(1,2))
.addExceptionToAction(jakarta.resource.ResourceException.class, org.ikasan.builder.OnException.ignore()))
.build();
return myFlow1;
}
}