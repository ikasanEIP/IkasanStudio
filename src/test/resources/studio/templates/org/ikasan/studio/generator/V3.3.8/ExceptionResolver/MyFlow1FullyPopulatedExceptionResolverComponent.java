...
.addExceptionToAction(javax.resource.ResourceException.class, org.ikasan.builder.OnException.ignore())
.addExceptionToAction(javax.jms.JMSException.class, org.ikasan.builder.OnException.retry(1,2)))
.build();
return myFlow1;
}
}