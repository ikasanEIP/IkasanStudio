...
public class TestDeepCopyDataWithDefaultConstructor {
    private String strAttribute1;
    private Integer intAttribute1;

    public TestDeepCopyDataWithDefaultConstructor() {

    }

    public TestDeepCopyDataWithDefaultConstructor(String strAttribute1, Integer intAttribute1) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TestDeepCopyDataWithDefaultConstructor)) return false;
        TestDeepCopyDataWithDefaultConstructor that = (TestDeepCopyDataWithDefaultConstructor) o;
