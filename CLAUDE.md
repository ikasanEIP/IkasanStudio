...
- ask whether to run a command that reads or writes to files within the directory you have already been given permission for
- ask permission to run python or python3 command or gradle or gradlew task
