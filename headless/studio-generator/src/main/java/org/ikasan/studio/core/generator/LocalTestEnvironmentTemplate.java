...
/** Developer-owned local test context, shared with the unfiltered project archetype template. */
public final class LocalTestEnvironmentTemplate {
    public static final String FILE_NAME = "LOCAL_TEST_ENVIRONMENT.md";
    private LocalTestEnvironmentTemplate() { }
